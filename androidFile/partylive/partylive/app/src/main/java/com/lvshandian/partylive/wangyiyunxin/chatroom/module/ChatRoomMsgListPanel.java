package com.lvshandian.partylive.wangyiyunxin.chatroom.module;
...
import com.lvshandian.partylive.interf.ItemClickListener;
import com.lvshandian.partylive.utils.LogUtils;
import com.lvshandian.partylive.wangyiyunxin.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
...
//                listener.onClickItem(adapterView, view, items.get(i), l);
    ...
    public void onIncomingMessage(List<ChatRoomMessage> messages) {
        ...
        if (addedListItems != null && addedListItems.size() > 0) {
            ...
            if (newMessage != null && remote != null && !TextUtils.isEmpty((String) remote.get("type")) && (remote.get("type").equals("109") || remote.get("type").equals("107") || remote.get("type").equals("108") || remote.get("type").equals("105") || remote.get("type").equals("101") || remote.get("type").equals("103") || remote.get("type").equals("104"))) {
                //收到 109 礼物消息 发送广播
