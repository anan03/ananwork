...
public class ImagerLoadUtils {
     ...
     * @throws Exception
     */
    public static void uploadFile(Context context, String userId, String path, String url, final Handler mHandler) throws Exception {
