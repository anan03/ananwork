package com.lvshandian.partylive.wangyiyunxin.session.viewholder;
...
import com.lvshandian.partylive.wangyiyunxin.session.activity.WatchSnapChatPictureActivity;
