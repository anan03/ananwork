package com.lvshandian.partylive.wangyiyunxin.session;
...
import com.lvshandian.partylive.wangyiyunxin.contact.activity.UserProfileActivity;
import com.lvshandian.partylive.wangyiyunxin.session.action.AVChatAction;
import com.lvshandian.partylive.wangyiyunxin.session.action.FileAction;
import com.lvshandian.partylive.wangyiyunxin.session.action.GuessAction;
import com.lvshandian.partylive.wangyiyunxin.session.action.RTSAction;
import com.lvshandian.partylive.wangyiyunxin.session.action.SnapChatAction;
import com.lvshandian.partylive.wangyiyunxin.session.action.TipAction;
import com.lvshandian.partylive.wangyiyunxin.session.activity.MessageHistoryActivity;
import com.lvshandian.partylive.wangyiyunxin.session.activity.MessageInfoActivity;
import com.lvshandian.partylive.wangyiyunxin.session.extension.CustomAttachParser;
import com.lvshandian.partylive.wangyiyunxin.session.extension.CustomAttachment;
...
import com.lvshandian.partylive.wangyiyunxin.session.search.SearchMessageActivity;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderAVChat;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderDefCustom;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderFile;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderGuess;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderRTS;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderSnapChat;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderSticker;
import com.lvshandian.partylive.wangyiyunxin.session.viewholder.MsgViewHolderTip;
