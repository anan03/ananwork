...
import com.lvshandian.partylive.wangyiyunxin.main.adapter.SystemMessageAdapter;
import com.lvshandian.partylive.wangyiyunxin.main.viewholder.SystemMessageViewHolder;
...
//        options.titleId = R.string.verify_reminder;
    ...
    private void deleteSystemMessage(final SystemMessage message) {
        ...
        refresh();
        ToastUtils.showSnackBar(title, R.string.delete_success);
    }
}
