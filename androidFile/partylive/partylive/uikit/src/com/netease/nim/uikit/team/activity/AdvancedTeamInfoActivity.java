...
public class AdvancedTeamInfoActivity extends UI implements
    ...
    public static void start(Context context, String tid, String userId) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        title = (TextView) findViewById(R.id.team_info_title);
...
//        NimUIKit.startContactSelect(AdvancedTeamInfoActivity.this, option, REQUEST_CODE_CONTACT_SELECT);
        startActivityForResult(new Intent(this, FollowListForGroupUikitActivity.class).putExtra("userId", userId), REQUEST_CODE_CONTACT_SELECT);
    }
