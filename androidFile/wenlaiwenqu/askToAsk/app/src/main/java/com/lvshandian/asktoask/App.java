...
public class App extends Application {
    ...
    public static RequestQueue requestQueueiInstance() {
    ...
    public static void finishActivity() {
        ...
        Global.setParam(mContext, Constant.USERID, "");
        Global.setParam(mContext, Constant.ISLOGIN, false);
...
//初始化
    ...
    public DisplayImageOptions getOption() {
        DisplayImageOptions option = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.no_pic)//设置图片下载期间显示的图片
