...
public class TestPicActivity extends Activity {
    ...
    public static TestPicActivity testPic;

    public static TestPicActivity getInstance() {

        if (testPic == null) {

            testPic = new TestPicActivity();
        }
    ...
    private void initView() {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent.putExtra("bucketName", dataList.get(position).bucketName);
