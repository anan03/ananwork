package com.lvshandian.asktoask.pay;
...
public class PayDemoActivity extends FragmentActivity {
	...
	// 商户PID
	public static final String PARTNER = "2088421691929373";
	// 商户收款账号
	public static final String SELLER = "home@wenlaiwenqu.com";
	// 商户私钥，pkcs8格式
	public static final String RSA_PRIVATE = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBANxLH+KxXCheCyN/"+
	...
	public void pay(View v) {
		...
		String orderInfo = getOrderInfo("问来问去", "该测试商品的详细描述", "0.01");
