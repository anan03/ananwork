...
public class RecycleViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecycleViewHolder(Context context, View itemView, ViewGroup parent, int position) {
        super(itemView);
        mContext = context;
    ...
    public static RecycleViewHolder get(Context context, View convertView,
        ...
        if (convertView == null) {
            ...
            RecycleViewHolder holder = new RecycleViewHolder(context, itemView, parent, position);
