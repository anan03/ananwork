...
public class FragmentPagerAdapter extends android.support.v4.app.FragmentPagerAdapter {
    ...
    public FragmentPagerAdapter(FragmentManager fm, Fragment[] fragmentClass, List<String> titles, Bundle[] mBundles) {
        super(fm);
        this.fm = fm;
    ...
    public FragmentPagerAdapter(FragmentManager fm, Fragment[] fragmentClass, Bundle[] mBundles) {
        super(fm);
        this.fragmentClass = fragmentClass;
        this.mBundles = mBundles;
    }
